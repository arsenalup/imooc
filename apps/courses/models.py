...
class Course(models.Model):
    ...
    image = models.ImageField(upload_to='courses/%Y/%m', verbose_name='封面', max_length=100, blank=True)
    click_nums = models.IntegerField(default=0, verbose_name='点击数')
    category = models.CharField(max_length=20, verbose_name='课程类别', default='后端开发')
    youneed_know = models.CharField(max_length=300, verbose_name='课程须知', default='')
    teacher_tell = models.CharField(max_length=300, verbose_name='课程收获', default='')
